...
import com.senla.build.config.Constants;
import com.senla.build.json.writer.JsonWriterUtil;
import com.senla.controller.action.guest.AddGuestToRoomAction;
import com.senla.controller.action.guest.CreateGuestAction;
import com.senla.controller.action.guest.DeleteGuestAction;
import com.senla.controller.action.guest.ExportGuestDataAction;
import com.senla.controller.action.guest.ImportGuestDataAction;
import com.senla.controller.action.guest.PrintAllAmountAction;
import com.senla.controller.action.guest.PrintAllSortedAlphabet;
import com.senla.controller.action.guest.PrintAllSortedByCheckoutDate;
import com.senla.controller.action.guest.PrintAllSortedGuestAdditionOrder;
import com.senla.controller.action.guest.PrintGuestByIdAction;
import com.senla.controller.action.guest.PrintGuestPaymentAction;
import com.senla.controller.action.guest.RemoveGuestFromRoomAction;
import com.senla.controller.action.maintenance.ChangeMaintenancePriceAction;
import com.senla.controller.action.maintenance.CreateMaintenanceAction;
import com.senla.controller.action.maintenance.ExportMaintenanceDataAction;
import com.senla.controller.action.maintenance.ImportMaintenanceDataAction;
import com.senla.controller.action.maintenance.OrderMaintenanceAction;
import com.senla.controller.action.room.ChangeRoomPriceAction;
import com.senla.controller.action.room.ChangeRoomStatusAction;
import com.senla.controller.action.room.CreateRoomAction;
import com.senla.controller.action.room.ExportRoomDataAction;
import com.senla.controller.action.room.ImportRoomDataAction;
import com.senla.controller.action.room.PrintAllSortedByCapacity;
import com.senla.controller.action.room.PrintAllSortedByStars;
import com.senla.controller.action.room.PrintAllSortedRoomAdditionOrder;
import com.senla.controller.action.room.PrintFreeRoomsAction;
import com.senla.controller.action.room.PrintFreeRoomsAmountAction;
import com.senla.controller.action.room.PrintFreeRoomsSortedAdditionOrder;
import com.senla.controller.action.room.PrintFreeRoomsSortedByCapacity;
import com.senla.controller.action.room.PrintFreeRoomsSortedByPrice;
import com.senla.controller.action.room.PrintFreeRoomsSortedByStars;
import com.senla.controller.action.room.PrintNLastGuestsAction;
import com.senla.controller.action.room.PrintRoomByIdAction;
import com.senla.controller.action.room.PrintRoomDetailsAction;
import com.senla.controller.entity.Menu;
import com.senla.controller.entity.MenuItem;
...
public class BuilderImpl implements Builder {
    ...
    public void buildMenu() {
        ...
        guestMenuItemsList.add(new MenuItem("Список гостей", new com.senla.controller.action.guest.PrintAllAction(guestService, roomService, maintenanceService), guestSortingMenu, rootMenu));
        ...
        roomMenuItemsList.add(new MenuItem("Список номеров", new com.senla.controller.action.room.PrintAllAction(guestService, roomService, maintenanceService), roomSortingMenu, rootMenu));
        ...
        roomSortingMenuItemList.add(new MenuItem("Сортировать по цене", new com.senla.controller.action.room.PrintAllSortedByPrice(guestService, roomService, maintenanceService), null, roomMenu));
        ...
        /*maintenanceMenuItemsList.add(new MenuItem("Список услуг", new PrintAllAction(guestService, roomService, maintenanceService), maintenanceSortingMenu, rootMenu));
